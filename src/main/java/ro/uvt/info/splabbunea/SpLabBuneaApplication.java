...
import ro.uvt.info.splabbunea.injection.ClientComponent;
import ro.uvt.info.splabbunea.injection.SingletonComponent;
import ro.uvt.info.splabbunea.injection.TransientComponent;
import ro.uvt.info.splabbunea.controllers.HelloWorld;
...
// Gets a handle of dependency injection context
        ApplicationContext context =
                SpringApplication.run(SpLabBuneaApplication.class, args);
